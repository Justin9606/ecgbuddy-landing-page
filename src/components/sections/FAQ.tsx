      ...
      questions: [
        {
          ...
          answer:
            "ECG Buddy uses advanced AI algorithms trained on millions of ECG patterns to analyze your cardiac data. Simply upload your ECG file, and our system processes it in under 30 seconds, providing detailed analysis including rhythm classification, abnormality detection, and clinical recommendations.",
          highlights: [
            "AI-powered analysis",
            "Under 30 seconds",
        ...
        },
        {
          ...
          answer:
            "We support all major ECG formats including PDF, XML, SCP-ECG, DICOM, and HL7 FHIR. Our system can also process images (PNG, JPG) of ECG printouts using advanced OCR technology.",
          highlights: [
            "PDF, XML, SCP-ECG",
            "DICOM, HL7 FHIR",
            "Image processing",
        ...
        },
        {
          ...
          answer:
            "Yes, ECG Buddy is fully HIPAA compliant with end-to-end encryption, secure data transmission, and comprehensive audit trails. All patient data is encrypted both in transit and at rest using AES-256 encryption.",
          highlights: [
            "HIPAA compliant",
      ...
      questions: [
        {
          ...
          answer:
            "Our AI model achieves 99.2% accuracy in clinical validation studies, trained on over 1 million ECG samples from leading medical institutions. The system is continuously updated with new data to maintain peak performance.",
          highlights: [
            "99.2% accuracy",
            "1M+ training samples",
            "Continuous updates",
        ...
        },
        {
          ...
          answer:
            "Yes, we offer seamless integration with 200+ EMR systems including Epic, Cerner, and Allscripts. Our API supports HL7 FHIR standards and can be customized for your specific workflow requirements.",
          highlights: [
            "200+ EMR systems",
            "HL7 FHIR support",
            "Custom workflows",
        ...
        },
        {
          ...
          answer:
            "Our mobile and desktop apps support offline analysis for emergency situations. The AI model runs locally on your device, ensuring you can analyze ECGs even without internet connectivity.",
          highlights: [
            "Offline capability",
            "Local AI processing",
            "Emergency ready",
      ...
      questions: [
        {
          ...
          answer:
            "Yes, we offer a 14-day free trial with full access to all features. No credit card required. You can analyze up to 100 ECGs during the trial period.",
          highlights: [
            "14-day free trial",
            "No credit card",
            "100 ECG analyses",
        ...
        },
        {
          ...
          answer:
            "We offer flexible pricing: Starter ($29/month for individuals), Professional ($99/month for small teams), and Enterprise (custom pricing for large organizations). All plans include unlimited analyses and 24/7 support.",
          highlights: [
            "Starter $29/month",
        ...
        },
        {
          ...
          answer:
            "Yes, we provide significant discounts for high-volume users and enterprise customers. Contact our sales team for custom pricing based on your analysis volume and specific requirements.",
          highlights: [
            "Volume discounts",
            "Enterprise pricing",
            "Custom solutions",
      ...
      questions: [
        {
          ...
          answer:
            "24/7 technical support via chat, email, and phone. We also offer onboarding assistance, training sessions, and dedicated account managers for enterprise customers.",
          highlights: [
            "24/7 support",
            "Multiple channels",
            "Dedicated managers",
        ...
        },
        {
          ...
          answer:
            "We use bank-level security with SOC 2 Type II compliance, regular security audits, and zero-trust architecture. Data is automatically deleted after your specified retention period.",
          highlights: [
            "SOC 2 Type II",
            "Zero-trust security",
            "Auto data deletion",
        ...
        },
        {
          ...
          answer:
            "Yes, you can export results in multiple formats including PDF reports, structured data (JSON/XML), and direct integration with your EMR system. All exports maintain full audit trails.",
