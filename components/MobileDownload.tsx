...
const MobileDownload = () => {
  ...
  const apps = [
    ...
    },
    {
      ...
      features: ['Desktop Integration', 'Multi-Monitor Support', 'Batch Processing', 'Enterprise SSO']
    }
  ];
  ...
  return (
    <section id="mobile-download" className="relative py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 w-72 h-72 bg-gradient-to-br from-pink-200/20 to-rose-200/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center space-x-3 bg-white/60 backdrop-blur-2xl border border-red-100/50 rounded-full px-6 py-3 mb-8 shadow-[0_8px_32px_rgba(255,63,74,0.08)]">
            ...
            <span className="text-sm font-medium text-slate-700">Mobile & Desktop Apps</span>
          </div>
          ...
          <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light">
            Access powerful ECG analysis on any device. Download our native apps for seamless 
            real-time analysis, cloud sync, and platform-specific integrations.
          </p>
        </motion.div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {apps.map((app, index) => (
                  ...
                  >
                    ...
                    <div className="relative text-slate-800 font-medium text-sm text-center">{app.name}</div>
                    <div className="relative text-slate-500 text-xs text-center mt-1">{app.platform}</div>
                  ...
                  <div className="flex-1">
                    ...
                    >
                      <div className="text-slate-500">
                        <span className="text-slate-800 font-medium">{activeAppData.version}</span> • {activeAppData.size}
                      </div>
                      <div className="flex items-center space-x-1">
                        <Star className="w-4 h-4 text-yellow-500 fill-current" />
                        <span className="text-slate-800 font-medium">{activeAppData.rating}</span>
                        <span className="text-slate-500">({activeAppData.downloads})</span>
                      </div>
                    </motion.div>
                  </div>
                </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="relative inline-flex items-center space-x-2 bg-red-100/50 backdrop-blur-sm border border-red-200/50 rounded-full px-4 py-2 mb-6">
                  ...
                  <span className="text-sm font-medium text-red-700">Scan to Download</span>
                </div>
                ...
                <div className="relative mb-8">
                  ...
                  >
                    <div className="text-center">
                      ...
                      >
                        QR Code will be loaded<br />from admin configuration
                      </motion.div>
                    </div>
                  </motion.div>
                ...
                <motion.p 
                  ...
                  transition={{ delay: 0.5, duration: 0.4 }}
                >
                  Point your camera at the QR code to instantly download the {activeAppData.name} 
                  and start analyzing ECGs on your {activeAppData.platform.toLowerCase()}.
                </motion.p>
              </motion.div>
            </AnimatePresence>
        ...
        >
          {[
            ...
            },
            {
              ...
              description: 'Deep integration with platform-specific features like HealthKit, Google Health, and Windows Hello.',
